        ...
        <div class="col-xs-12">
          <h2 class="page-header">
            <div style="display: inline-flex; align-items: center;">
              ...
              <div style="color: #f33;">HaiYenStore</div>
            </div>
      ...
      <div class="invoice-info">
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
            ...
            <br>
            <address>
              <b>Admin HaiYenStore</b><br>
              Phone: (+84) 967 999 999<br>
              Email: HaiYenstore@gmail.com<br>
              Address: Số 1 Kiệt 92 Đường Lê Đại Hành, Phường Tây Lộc, Thừa Thiên Huế.
            </address>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-3">
            To: <br>
