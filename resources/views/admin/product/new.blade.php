      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="monitor"> Thuộc Series: <span class="text-red">*</span></label>
                <input type="text" name="monitor" class="form-control" id="monitor" placeholder="Thuộc series" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="front_camera">Mặt trước: <span class="text-red">*</span></label>
                <input type="text" name="front_camera" class="form-control" id="front_camera" placeholder="Mặt trước" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="rear_camera">Mặt sau :<span class="text-red">*</span></label>
                <input type="text" name="rear_camera" class="form-control" id="rear_camera" placeholder="Mặt sau" required autocomplete="off">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label>Thể loại <span class="text-red">*</span></label>
                <select class="form-control" name="OS" required>
                  <option value="">-- Chọn hệ điều hành --</option>
                  <option value="Android">Super</option>
                  <option value="IOS">Bandai</option>
                  <option value="Windows Phone">Japan</option>
                </select>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="CPU">Dạng chuyển <span class="text-red">*</span></label>
                <input type="text" name="CPU" class="form-control" id="CPU" placeholder="Dạng chuyển" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="GPU">Dạng phát triển <span class="text-red">*</span></label>
                <input type="text" name="GPU" class="form-control" id="GPU" placeholder="Dạng phát triển" required autocomplete="off">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="RAM">Biên độ cử động <span class="text-red">*</span></label>
                <input type="number" min="1" name="RAM" class="form-control" id="RAM" placeholder="Biên độ cử động" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="ROM">Cân nặng (G) <span class="text-red">*</span></label>
                <input type="number" min="1" name="ROM" class="form-control" id="ROM" placeholder="Cân nặng" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="pin">Cơ năng hoạt động: <span class="text-red">*</span></label>
                <input type="text" name="pin" class="form-control" id="pin" placeholder="Cơ năng hoạt động" required autocomplete="off">
              </div>
            </div>
          </div>
        </div>
