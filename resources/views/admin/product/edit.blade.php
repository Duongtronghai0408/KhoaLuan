      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="front_camera">Trước <span class="text-red">*</span></label>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="rear_camera">Sau <span class="text-red">*</span></label>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control" name="OS" required>
                  ...
                  <option value="IOS" {{ $product->OS == 'HG WODOM POD' ? 'selected' : '' }}>HG WODOM POD</option>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="CPU">Dạng <span class="text-red">*</span></label>
