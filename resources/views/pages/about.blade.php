            ...
            <div class="content-left">
              <div class="note">
                ...
                <div class="note-content">
                  <p>Website <strong>Hải Yến</strong> là một sản phẩm của đồ án tốt nghiệp đề tài: <i>Thiết kế website thương mại điện tử kinh doanh GunDame</i></p>
                </div>
              </div>
              <div class="content">
                <p>Công nghệ thông tin trong giai đoạn hiện nay đang có những bước phát triển như vũ bão trên mọi lĩnh vực hoạt động ở khắp nơi trên toàn thế giới, điều xảy ra trong vòng vài năm vừa qua ở Việt Nam là sự đầu tư ồ ạt vào công nghệ. </p>
