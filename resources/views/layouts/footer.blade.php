        ...
        <div class="col-md-3 col-sm-4 col-xs-6 col-ssm">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <p><b><i class="fas fa-mobile-alt"></i> Hotline:</b> <a href="tel:(+84) 967 999 999">(+84) 935 589 999</a></p>
              <p><b><i class="fas fa-envelope"></i> Email:</b> <a href="mailto:phonestore@gmail.com" rel="nofollow">duongtronghai0408@gmail.com</a></p>
              <p><b><i class="fas fa-store-alt"></i> Địa chỉ:</b><a href="" rel="nofollow">Thừa Thiên Huế</a></p> </p>
            </div>
          </div>
        </div>
